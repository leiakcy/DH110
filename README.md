...
| **#7 Flexibility and efficiency of use**: Design that ease users to tailor frequent actions | 2 | Although the navigation bar acts as a good filter for different coverages, there is no search button that allow users to find specic information quickly. |
