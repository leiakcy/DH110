...
| **#3 User control and freedom**: Users can undo or redo when mistakes were made | 3 | Users can always return to the previous page, with a simple "back" button. |
...
| **#5 Error prevention**: Design can prevent problems from surfacing | 1 | Having a search button that provides text input and suggestions can help users in searching the information they desire. Because of the confusing navigation and menu layout, it is possible for users to click on the wrong item. 
| **#6 Recognition rather than recall**: Information required for the design should be easily retrievable | 2 | The overall design and terminology of the website makes it difficult for users to recall the workings of the system. For instance, the 
